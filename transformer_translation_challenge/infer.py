...
from configs import PRESET_REGISTRY, Config, get_config
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Challenge version Transformer inference")
    parser.add_argument(
        "--preset",
        type=str,
        default="baseline",
        choices=sorted(PRESET_REGISTRY.keys()),
        help="Which trained experiment preset checkpoint to load.",
    )
    parser.add_argument(
        "--sentence",
        type=str,
